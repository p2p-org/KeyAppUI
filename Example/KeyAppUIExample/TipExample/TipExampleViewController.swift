...
extension TipExampleViewController: TipManagerDelegate {
    func next(after number: Int) {
        ...
        switch number {
        case 0:
            nextTip = tipManager.createTip(content: createTipContent(number: 1, count: 5), theme: .night, position: .topRight)
        ...
        case 3:
            nextTip = tipManager.createTip(content: createTipContent(number: 4, count: 5), theme: .night, position: .rightBottom)
            view.addSubview(nextTip)
        ...
        case 4:
            nextTip = tipManager.createTip(content: createTipContent(number: 5, count: 5), theme: .lime, position: .leftTop)
            view.addSubview(nextTip)
